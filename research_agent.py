...
"""
    ...
    def task(description: str, subagent_type: str) -> str:
        ...
        if "research" in normalized:
            ...
            result = research_agent.invoke({"messages": [{"role": "user", "content": description}]})
        ...
        return f"Error: '{subagent_type}' is not a recognized agent. Please use 'research'."

    # 🔹 Create main agent
    # Indentation Fixed: This is now outside the 'task' function but inside 'setup_agent'
