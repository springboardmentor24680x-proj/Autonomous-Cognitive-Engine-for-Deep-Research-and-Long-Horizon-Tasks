...
# ==============================
# TOOL 1: TODO GENERATOR
# ==============================
def write_todos_tool(state: State):
    prompt = f"""
Break the following request into numbered TODO steps.
...
def plan_todo_tool(state: State):
    ...
    prompt = f"""
Create a phase-based plan from these TODOs:
...
# ==============================
# MILESTONE 3 – DECISION NODE
# ==============================
def decide_delegation_tool(state: State):
    prompt = f"""
Decide task handling.
