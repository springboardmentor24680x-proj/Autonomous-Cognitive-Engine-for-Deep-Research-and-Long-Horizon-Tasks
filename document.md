...
	Intent Interpretation: Transforms user intent into actionable tasks.
	Task Delegation: Generates execution plans and assigns tasks to specialized agents.
	State Management: Maintains the shared memory and produces a coherent final response
* **Responsibilities**
